                        ...
                        <div className="pt-4">
                            ...
                            <div className="mt-2">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <button onClick={() => dispatch({ schedule: 3600 })} className={`cursor-pointer ${schedule !== 3600 ? "bg-white/5 hover:bg-white/10" : " bg-blue-600/40  hover:bg-blue-600/60"} px-3 py-1 rounded text-sm transition`}>Every hour</button>
